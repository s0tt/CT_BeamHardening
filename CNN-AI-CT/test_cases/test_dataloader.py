...
class TestDataloader_x20_y20_z20(unittest.TestCase):
    ...
    def test_idx_0(self): 
        ...
        with h5py.File(self.dataset_path_x20_y20_z20[0][0], 'r') as h5f:
            ...
            sample_bh_self_extracted = volume_bh[: self.num_pixel, :5, : self.num_pixel]
    ...
    def test_idx_1(self): 
        ...
        with h5py.File(self.dataset_path_x20_y20_z20[0][0], 'r') as h5f:
            volume_bh = h5f['Volume']
            sample_bh_self_extracted = volume_bh[ self.stride: self.stride + self.num_pixel, :5, : self.num_pixel]
        self.assertTrue(np.array_equal(sample_bh_self_extracted, dataset_bh), "Slices are not equal")
    ...
    def test_idx_40(self): 
        ...
        with h5py.File(self.dataset_path_x20_y20_z20[0][0], 'r') as h5f:
            volume_bh = h5f['Volume']
            sample_bh_self_extracted = volume_bh[self.stride*4: self.stride*4 + self.num_pixel, 1:6, : self.num_pixel]
        self.assertTrue(np.array_equal(sample_bh_self_extracted, dataset_bh), "Slices are not equal")
    ...
    def test_idx_140(self): 
        ...
        with h5py.File(self.dataset_path_x20_y20_z20[0][0], 'r') as h5f:
            volume_bh = h5f['Volume']
            sample_bh_self_extracted = volume_bh[self.stride*2: self.stride*2 + self.num_pixel, 3:8, self.stride*5 : self.stride*5 + self.num_pixel]
        self.assertTrue(np.array_equal(sample_bh_self_extracted, dataset_bh), "Slices are not equal")
    ...
    def test_idx_380(self): 
        ...
        with h5py.File(self.dataset_path_x20_y20_z20[0][0], 'r') as h5f:
            volume_bh = h5f['Volume']
            sample_bh_self_extracted = volume_bh[self.stride*2: self.stride*2 + self.num_pixel, 10:15, self.stride*3 : self.stride*3 + self.num_pixel]
        self.assertTrue(np.array_equal(sample_bh_self_extracted, dataset_bh), "Slices are not equal")
    ...
    def test_idx_527(self): 
        ...
        with h5py.File(self.dataset_path_x20_y20_z20[0][0], 'r') as h5f:
            volume_bh = h5f['Volume']
            sample_bh_self_extracted = volume_bh[self.stride*5: self.stride*5 + self.num_pixel, 14:19, self.stride*3 : self.stride*3 + self.num_pixel]
        self.assertTrue(np.array_equal(sample_bh_self_extracted, dataset_bh), "Slices are not equal")
...
class TestDataloader_zuendkerze_bad(unittest.TestCase):
    ...
    def test_idx_99(self): 
        ...
        with h5py.File(self.dataset_path_zuendkerze[0][0], 'r') as h5f:
            volume_bh = h5f['Volume']
            sample_bh_self_extracted = volume_bh[self.stride*7: self.stride*7 + self.num_pixel, :5, self.stride*4: self.stride*4 + self.num_pixel]
        self.assertTrue(np.array_equal(sample_bh_self_extracted, dataset_bh), "Slices are not equal")
    ...
    def test_idx_1999(self): 
        ...
        with h5py.File(self.dataset_path_zuendkerze[0][0], 'r') as h5f:
            volume_bh = h5f['Volume']
            sample_bh_self_extracted = volume_bh[self.stride*21: self.stride*21 + self.num_pixel, 3:8, self.stride*17: self.stride*17 + self.num_pixel]
        self.assertTrue(np.array_equal(sample_bh_self_extracted, dataset_bh), "Slices are not equal")
    ...
    def test_idx_99999(self): 
        ...
        with h5py.File(self.dataset_path_zuendkerze[0][0], 'r') as h5f:
            volume_bh = h5f['Volume']
            sample_bh_self_extracted = volume_bh[self.stride*18: self.stride*18 + self.num_pixel, 189:194,  : self.num_pixel]
        self.assertTrue(np.array_equal(sample_bh_self_extracted, dataset_bh), "Slices are not equal")
